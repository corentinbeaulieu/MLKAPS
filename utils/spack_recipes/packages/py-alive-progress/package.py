...
class PyAliveProgress(PythonPackage):
    ...
    pypi = "alive-progress/alive-progress-3.1.5.tar.gz"

    license("MIT")

    version("3.1.5", sha256="42e399a66c8150dc507602dff7b7953f105ef11faf97ddaa6d27b1cbf45c4c98")
